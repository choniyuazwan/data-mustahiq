              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    ...
                    <div class="checkbox col-sm-6 col-md-4 col-xl-2">
                      <label>
                        <input type="checkbox" name="jenisprogram[]" value="Bogor Sejahtera" <?php echo set_checkbox('jenisprogram[]', 'Bogor Sejahtera'); ?> >Bogor Sejahtera
                      </label>
                    </div>

                    <div class="checkbox col-sm-6 col-md-4 col-xl-2">
                      <label>
                        <input type="checkbox" name="jenisprogram[]" value="Bogor Aman" <?php echo set_checkbox('jenisprogram[]', 'Bogor Aman'); ?> >Bogor Aman
                      </label>
                    </div>

                    <div class="checkbox col-sm-6 col-md-4 col-xl-2">
                      <label>
                        <input type="checkbox" name="jenisprogram[]" value="Bogor Bahagia" <?php echo set_checkbox('jenisprogram[]', 'Bogor Bahagia'); ?> >Bogor Bahagia
                      </label>
                    </div>
                  </div>
                </div>
